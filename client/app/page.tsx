    ...
    <>
      <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6">
        <Link className="mr-6 hidden lg:flex" href="#">
          ...
          <span className="sr-only">Law Firm</span>
        </Link>
      ...
      <main className="flex flex-col items-center justify-center space-y-10 py-20">
        <h1 className="text-4xl font-bold">Welcome to Our Law Firm</h1>
        <p className="text-lg text-gray-500 dark:text-gray-400">
          We are committed to providing the highest quality legal services.
        </p>
